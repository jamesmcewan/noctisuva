...
" Vim Color File
" Name:       noctisuva.vim
" Maintainer: https://github.com/jamesmcewan/noctisuva.vim
...
if !exists("g:noctisuva_termcolors")
  let g:noctisuva_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:noctisuva_terminal_italics")
  let g:noctisuva_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
function! s:h(group, style)
  if g:noctisuva_terminal_italics == 0
...
function! noctisuva#set_highlight(group, style)
...
let s:colors = noctisuva#GetColors()
